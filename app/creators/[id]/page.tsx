...
const mockReviews = [
  {
    ...
    userName: "John Doe",
    rating: 5,
    comment: "Excellent creator! Fast shipping and great customer service. Products are exactly as described.",
    date: "2024-01-15",
  },
  {
    id: "2",
        ...
        <div className="container mx-auto px-4">
              ...
              <CardContent className="p-6">
                <div className="flex flex-col gap-6 md:flex-row md:items-start">
                  <Avatar className="h-32 w-32 border-4 border-background">
                    <AvatarImage src={creator.logo} alt={creator.name} />
                      ...
                      <div>
                        ...
                        <div className="mt-2 flex items-center gap-4 text-sm text-muted-foreground">
                          <div className="flex items-center gap-1">
                            ...
                            <span>({creator.reviewCount.toLocaleString()} reviews)</span>
                          </div>
                          <span>•</span>
                          <span>{creator.totalProducts} Products</span>
                          <span>•</span>
                    ...
                    <div className="mt-6 grid gap-4 sm:grid-cols-3">
                      ...
                      <div className="flex items-center gap-3 rounded-lg border border-border p-3">
                        ...
                        <div>
                          ...
                          <p className="font-medium">{creator.responseTime}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 rounded-lg border border-border p-3">
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {new Date(creator.joinedDate).getFullYear()}
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <Tabs defaultValue="products" className="w-full">
            <TabsList className="w-full justify-start border-b rounded-none h-auto p-0 bg-transparent">
              ...
              >
                Products ({creator.totalProducts})
              </TabsTrigger>
              <TabsTrigger
                value="about"
                className="rounded-none border-b-2 border-transparent data-[state=active]:border-primary"
                  ...
                  <CardContent className="p-6">
                    <div className="grid gap-8 md:grid-cols-2">
                      <div className="text-center">
                        <div className="text-5xl font-bold">{creator.rating}</div>
                        <div className="flex justify-center mt-2">
                          {[...Array(5)].map((_, i) => (
                            <Star
                              key={i}
                              className={`h-6 w-6 ${i < Math.floor(creator.rating)
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                          Based on {creator.reviewCount.toLocaleString()} reviews
                        </p>
                      </div>
