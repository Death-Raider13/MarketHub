...
function CreatorHubSettingsContent() {
  ...
  // Business Information (Hub name, email, phone, address come from user profile)
    ...
    async function loadSettings() {
      ...
      try {
        ...
        if (data.settings) {
          ...
          // Business Info (Hub info comes from user profile)
          if (s.businessInfo) {
          ...
          // Policies
          if (s.policies) {
            setRefundPolicy(s.policies.refund || s.policies.return || "")
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 bg-muted/30">
        <div className="container mx-auto px-4 py-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold">Hub Settings</h1>
            <p className="text-muted-foreground">Manage your hub information, payments, and preferences</p>
          </div>
            ...
            <div className="lg:col-span-3 min-w-0">
              <Tabs defaultValue="general" className="space-y-6">
                ...
                <TabsContent value="general" className="space-y-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Your hub's contact information. To edit these, go to your Profile Settings.
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      ...
                      <div className="bg-muted/50 p-4 sm:p-6 rounded-lg space-y-4 border">
                        ...
                        <p className="text-xs text-muted-foreground mt-4">
                          These details are used throughout the platform and on your public hub page.
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                ...
                <TabsContent value="business" className="space-y-6">
                  <Card>
                    <CardHeader>
                      <CardTitle>Hub Policies</CardTitle>
                      <CardDescription>Define your hub policies for digital products and services</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          rows={3}
                          placeholder="e.g. All digital sales are final, but we offer support for any technical issues."
                        />
                      </div>
...
export default function CreatorHubSettingsPage() {
  return (
    <ProtectedRoute allowedRoles={["creator"]}>
      <CreatorHubSettingsContent />
    </ProtectedRoute>
  )
}
