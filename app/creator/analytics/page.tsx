              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-muted-foreground">Hub Views</p>
                        <p className="text-2xl font-bold">{analytics?.hubViews.toLocaleString()}</p>
                ...
                <CardContent>
                  {analytics?.conversionFunnel ? (
                    <ResponsiveContainer width="100%" height={300}>
                       <BarChart
                        data={[
                          { stage: "Hub Visits", count: analytics.conversionFunnel.storeVisits },
