            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Thank you for applying to become a creator on FEROMARKETHUB. Your application is currently under review.
                </p>
                  ...
                  <ul className="space-y-3 text-sm text-muted-foreground">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p>Once approved, you can access your creator dashboard and start adding products</p>
                      </div>
                    </li>
                  </ul>
                </div>
