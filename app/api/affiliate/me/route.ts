  ...
  try {
    ...
    return NextResponse.json({
      ...
      affiliate: {
        ...
        totalEarnings: Number(user.affiliateTotalEarnings ?? user.earnings ?? 0) + Number(user.referralRewardEarnings ?? 0),
        availableBalance: Number(user.affiliateAvailableBalance ?? user.earnings ?? 0) + Number(user.referralRewardAvailableBalance ?? 0),
        ...
        affiliateStatus: user.affiliateStatus || 'pending_payment',
        referralRewardEarnings: Number(user.referralRewardEarnings ?? 0),
        referralRewardAvailableBalance: Number(user.referralRewardAvailableBalance ?? 0),
      },
      clicks,
      conversions,
      payouts,
