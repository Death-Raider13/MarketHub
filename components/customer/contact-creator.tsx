...
export function ContactCreator({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!user) {
      toast.error('Please login to contact the creator')
      return
    }
    ...
    try {
      ...
      const messageResponse = await fetch('/api/creator/messages/send', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
      ...
      toast.success('Message sent successfully! Check your Messages to see creator replies.')
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Send a message to the creator. They will be notified and can respond to your inquiry.
          </DialogDescription>
        </DialogHeader>
