...
2. **Service Products**: No customer confirmation emails were sent (only vendor notifications)
...
- Vendor notifications still work if customer email fails
