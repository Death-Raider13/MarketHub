...
export function usePermissions() {
  ...
  const canAccess = {
    ...
    // creator Management
    viewcreators: () => checkPermission('creators.view'),
    approvecreators: () => checkPermission('creators.approve'),
    editcreators: () => checkPermission('creators.edit'),
    deletecreators: () => checkPermission('creators.delete'),
